...
from collective.quickaccess.tests import layer
from collective.quickaccess.tests import utils
...
class UnitTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        from collective.quickaccess.browser.interfaces import ILayer
